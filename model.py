...
class Critic(nn.Module):
    ...
    def __init__(self, state_size, action_size, fcs1_units=512, fc2_units=512):
        """Initialize parameters and build model.
        Params
        ======
            state_size (int): Dimension of each state
        ...
        self.fc21 = nn.Linear(state_size + action_size, fc2_units)
        self.fc22 = nn.Linear(fc2_units, fc2_units)
